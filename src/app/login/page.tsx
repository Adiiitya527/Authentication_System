      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-root::after {
          ...
          width: 55%;
          height: 70%;
          background: radial-gradient(ellipse, rgba(255, 80, 120, 0.12) 0%, transparent 70%);
          pointer-events: none;
        }
        ...
        .field-input:focus {
          ...
          box-shadow: 0 0 0 3px rgba(99, 60, 255, 0.12);
        }
        ...
        .auth-btn:hover:not(:disabled) { transform: translateY(-1px); box-shadow: 0 8px 30px rgba(108, 63, 255, 0.4); }
